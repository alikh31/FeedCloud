...
class UserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['User']))
		{
			...
			$model->password = $this->createPasswordHash($model->password);
	...
	public function createPasswordHash($strPlainText) {
	
 		if (CRYPT_SHA512 != 1) {
 			throw new Exception('Hashing mechanism not supported.');
 		}
	
		return crypt($strPlainText, '$6$rounds=4567$Y9KQCzhq3RqXYJUj$');
	...
	public function loadModelByEmail($email)
	{
